...
import com.example.student_management.auth.dto.subject.SubjectCreateRequest;
import com.example.student_management.auth.dto.subject.SubjectResponse;
import com.example.student_management.auth.dto.subject.SubjectUpdateRequest;
...
public class SubjectService {
    ...
    public SubjectResponse create(SubjectCreateRequest req) {
        if (subjectRepo.existsById(req.id)) {
            throw new IllegalArgumentException("ID môn học đã tồn tại: " + req.id);
        }
